...
function Sidebar() {
  ...
  return (
    <aside className="w-[260px] shrink-0 rounded-3xl border border-black/5 bg-white/60 p-4 backdrop-blur shadow-[0_30px_80px_-60px_rgba(0,0,0,.35)]">
      <div className="flex items-center gap-3 px-2 py-2">
        <div className="h-10 w-10 rounded-2xl bg-gray-900/10" />
        <div>
    ...
    <main className="min-h-screen bg-[#efefef]">
      <div className="mx-auto max-w-6xl px-6 py-10">
        <div className="grid gap-6 lg:grid-cols-[260px_1fr]">
          ...
          <section className="rounded-3xl border border-black/5 bg-white/40 p-8 shadow-[0_30px_80px_-60px_rgba(0,0,0,.35)]">
            {/* Header (fixed overlap using wrapping flex layout) */}
              ...
              <div className="flex flex-wrap gap-3 md:justify-end">
                ...
                <div className="w-[180px]">
                  <Chip
                    ...
                    value={
                      deployment === "—" ? "—" : <Badge text={String(deployment)} />
                    }
                  />
                </div>
              </div>
